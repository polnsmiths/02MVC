...
public class Page {
	...
	///Field
	private int currentPage;		// 현재페이지                              >>현재2페이지
	private int totalCount;		// 총 게시물 수                                     >>176건
	private int pageUnit;			// 하단 페이지 번호 화면에 보여지는 수  >>5 (이전 1 2 3 4 5  이후)
	private int pageSize;			// 한 페이지당 보여지는 게시물수      >>3개 
