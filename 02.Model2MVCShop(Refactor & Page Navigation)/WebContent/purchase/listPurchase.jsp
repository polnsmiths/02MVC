...
<%
	...
	String proTranCode = (String)request.getAttribute("proTranCode");
...
%>	
	...
	<tr class="ct_list_pop">
		<td align="center">
			<a href="/getPurchase.do?tranNo=<%=purchase.getTranNo() %>
			&proTranCode=<%= proTranCode %>"><%=i +1 %></a>
		</td>
		<td></td>
		<td align="left">
		...
		<td></td>
		<td align="left">현재<%=purchase.getTranCode() %> 입니다.</td>
		<td></td>
		<td align="left">
		<% if(purchase.getTranCode().equals("배송중상태")){ %>
			<a href="/updateTranCode.do?tranNo=<%=purchase.getTranNo() %>">물건도착</a>
		<% } %>
		</td>
	</tr>
	<tr>
